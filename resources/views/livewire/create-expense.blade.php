...
<div>
    ...
    <form wire:submit.prevent="save">
        <div class="mb-4">
            <label>Amount</label>
            <input type="number" wire:model="amount" step="0.01" class="border rounded p-2 w-full">
        ...
        <button type="submit" class="bg-blue-500 text-white p-2 rounded">Save Expense</button>
    </form>
</div>